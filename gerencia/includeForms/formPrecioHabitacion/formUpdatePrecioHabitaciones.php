...
<div class="row">
	<div class="col-md-5 col-sm-4">
		...
		<div class="input-group form-group">
			...
			<input id="precioHabitacion" name="precioHabitacion" type="number" step="0.01" class="form-control habilitar" placeholder="$00.00" required="required" onKeyPress="if(this.value.length==10) return false;"/>
		</div>
	</div>
</div>
