<div class="row">
	...
	<div class="col-md-5 col-sm-4">
		...
		<div class="input-group form-group">
			...
			<input id="descuento" name="descuento" type="number" step="0.01" class="form-control habilitar" name="" placeholder="00.00%" required="required"/>
		</div>
	</div>
</div>
<br>
...
<div class="row">
	<div class="col-md-5 col-sm-5">
		...
		<div class="input-group date bt-datepicker">
			...
			<input id="fechaInicial" min=<?php //echo date('Y-m-d'); ?> type="text" class="form-control habilitar" name="fechaInicial" required="true">
		</div>
	</div>
	<div class="col-md-5 col-sm-5">
		...
		<div class="input-group date bt-datepicker">
			<span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
			<input id="fechaTermino" min=<?php //echo date('Y-m-d'); ?> type="text" class="form-control habilitar" name="fechaTermino" required="true">
		</div>
	</div>
</div>